import{c as _,r as w,j as e,f as V,C as G,M as Q,h as D,i as Y,g as K,k as X,X as Z,A as R}from"./index-BlggRd5c.js";import{s as i,u as J,P as W,a as ee}from"./Playbooks-BMcUc_un.js";/**
...
`):Be(g);return{value:Le(v,o,d),endIndex:l}}function He(n){const s=n[2]||n[4];return s==="-"?"strip":s==="+"?"keep":"clip"}function ze(n,s){for(let t=s+1;t<n.length;t+=1){const a=n[t];if(!(a.trim()===""||a.trimStart().startsWith("#")))return a}}function Ve(n){return n.replace(/^\uFEFF/,"").replace(/\r\n?/g,`
