...
## [0.2.0](https://github.com/leoncheng57/dcaleon/compare/v0.1.1...v0.2.0) (2026-09-20)
...
* **claude:** alert when the credential store becomes unreadable ([41936d6](https://github.com/leoncheng57/dcaleon/commit/41936d6afcc21d649326694759304aab5791cc3a))
...
* **deploy:** supervise with launchd on macOS and tmux on Linux ([f7b805e](https://github.com/leoncheng57/dcaleon/commit/f7b805e9c2d0fbc1c84cdab4a8f3211dfdf5bad8))
* **islands:** gate runtime islands per host and read Claude credentials on Linux ([94d89e5](https://github.com/leoncheng57/dcaleon/commit/94d89e5b17a3c60071b07c33528c6088fbaf45d1))
* **islands:** gate runtime islands per host and read Claude credentials on Linux ([5df148e](https://github.com/leoncheng57/dcaleon/commit/5df148e6c3f71a54546334fea37f502bccb00c5e))
...
* **theme:** adopt a warm paper light mode with green ink ([a8b7450](https://github.com/leoncheng57/dcaleon/commit/a8b7450c4382b6173e89cf70efc5dbcd02daed6c))
* **theme:** adopt a warm paper light mode with green ink ([efdcf93](https://github.com/leoncheng57/dcaleon/commit/efdcf939b898165a0df7aa3596b45eca6511565e)), closes [#518](https://github.com/leoncheng57/dcaleon/issues/518)
...
* **deploy:** wait for the port after killing the tmux session ([4b2314f](https://github.com/leoncheng57/dcaleon/commit/4b2314f43791ed0f9d2ea0c5df2e8de161158a19))
...
* **server:** bind loopback on Linux so the pod's tailnet cannot reach the BFF ([b3925a9](https://github.com/leoncheng57/dcaleon/commit/b3925a986d767eab09ab26542e3e0f7f356bb743))
* **server:** bind loopback on Linux so the pod's tailnet cannot reach the BFF ([02f2906](https://github.com/leoncheng57/dcaleon/commit/02f29069b69f35626db73046787325c6bd7fe9bd))
