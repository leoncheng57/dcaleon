...
export const api = {
  ...
  appConfig: () => fetch("/api/app-config").then((r) => json<{ publicAppUrl: string | null; dshEnabled: boolean; dshConfigured: boolean; claudeEnabled: boolean; claudeConfigured: boolean; islands?: { id: string; available: boolean; reason: string | null }[] }>(r)),
